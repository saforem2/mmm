...
Modified from:
<https://github.com/pytorch/torchtitan/blob/2a4437014e66bcf88a3f0419b816266e6326d539/torchtitan/profiling.py>
"""
...
def maybe_enable_memory_snapshot(config: JobConfig, *, global_step: int = 0):
    ...
    if enable_snapshot:
        ...
        logger.info(
            f'Memory profiler active. Snapshot will be saved at {snapshot_dir}'
        )
