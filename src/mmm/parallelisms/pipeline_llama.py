...
"""
mmm/parallelisms/pipeline_llama.py

Modified from:
<https://github.com/pytorch/torchtitan/blob/2a4437014e66bcf88a3f0419b816266e6326d539/torchtitan/parallelisms/pipeline_llama.py>
"""
...
from mmm.models.llama.model import ModelArgs

# from mmm.models.llama.model import ModelArgs
from mmm.parallelisms.pipelining_utils import (
...
def pipeline_llama_manual_split(
    ...
    microbatches = (
        job_config.experimental.pipeline_parallel_microbatches
        or parallel_dims.pp
    )
    splits = (
